...
public class FlutterDocumentPickerPlugin: NSObject, FlutterPlugin {
    private let delegate = FlutterDocumentPickerDelegate()
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = FlutterDocumentPickerPlugin()
    ...
    private func parseArgs(_ call: FlutterMethodCall) -> FlutterDocumentPickerParams? {
